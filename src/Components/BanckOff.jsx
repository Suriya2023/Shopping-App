    ...
    <div id='div-smart3' style={{transition: 'all 0.5s ease-in-out'}} className={`max-w-full bg-${props.mode}`}>
      <section className='containergd'>
        ...
        <div className="containergdd">
          ...
          <span class=" listimg3 list3 lazy-load-image-background blur-up lazy-load-image-loaded" style={{width: '100%', height: 'auto', backgroundColor: 'rgb(239, 240, 240)', borderRadius: '10px', objectFit: 'cover'}}> 
